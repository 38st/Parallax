...
`codex/wave-3-process-identity`. Its formal status remains **In progress** until
the implementation has a commit and exact remote green CI evidence. No
PROV-002 commit, SHA, pull request, or remote run exists yet. The dependency
baseline remains `5adf8d2`; [PR #10](https://github.com/38st/Parallax/pull/10)
run
