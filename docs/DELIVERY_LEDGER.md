...
| ID | Outcome | Dependencies | Status | Verification |
| --- | --- | --- | --- | --- |
| CI-001 | Enforce warnings-as-errors in ordinary CI. | PARSER-001, CORP-SEC-001, CORP-UX-001, PKG-001, DOC-001 | In progress | Local warning-clean release build and 712/712 warning-as-error tests pass at pushed branch head `8440098`; remote PR/CI pending. |
| CI-002 | Add pinned secret scanning with retained reports. | PARSER-001, CORP-SEC-001, CORP-UX-001, PKG-001, DOC-001 | In progress | Local gitleaks 8.30.1 canary/source scan and stale-evidence contracts pass at pushed branch head `8440098`; remote PR/CI pending. |
| CI-003 | Add product-only coverage reporting and an initial non-regression ratchet. | PARSER-001, CORP-SEC-001, CORP-UX-001, PKG-001, DOC-001 | In progress | Two isolated local runs are exactly 30,029/56,525 with identical stored report hashes at pushed branch head `8440098`; remote PR/CI pending. |
| CI-004 | Add source-to-catalog localization completeness checks. | DOC-001, CORP-UX-001 | In progress | Local contracts 13/13; census 789 keys/905 literals with zero new or stale debt at pushed branch head `8440098`; remote PR/CI pending. |
| CI-005 | Add separate ASan and TSan lanes. | CI-001 | In progress | Separate local ASan and TSan runs each pass 712/712 with clean diagnostics and isolated scratch cleanup at pushed branch head `8440098`; remote PR/CI pending. |
...
| PROV-001 | Port the pure exact-process provenance classifier and pre-open snapshotter. | PARSER-001, CORP-SEC-001, CORP-UX-001, PKG-001, DOC-001 | In progress | Focused 18/18, source typecheck, diff-check, and shared warning-as-error 712/712 pass; independent architecture rereview approved commit `790aebb`; remote PR/CI pending. |
| KEY-TEST-001 | Add randomized production Keychain CRUD characterization without touching real records. | PARSER-001, CORP-SEC-001, CORP-UX-001, PKG-001, DOC-001 | In progress | Required-mode local characterization 4/4 with zero skips and shared warning-as-error 712/712 pass; commit `2554a19`; remote PR/CI pending. |
| ACCT-FRESH-001 | Distinguish last successful refresh from last attempt, visibly mark retained values stale after failure or age expiry, and never present fallback values as current provider truth. | CORP-SEC-001, CORP-UX-001 | In progress | Frozen focused 36/36 and shared warning-as-error 712/712 pass; independent final race rereview approved commit `64631f0`; remote PR/CI pending. |
