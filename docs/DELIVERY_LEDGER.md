...
PROV-003 implementation is assigned to `/root/macos_architecture_audit` on the
same branch. Notifications are hints; exact identity polling is authoritative.
