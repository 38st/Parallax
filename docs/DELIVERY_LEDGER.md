...
in progress, so formal status remains **In progress**. Schema v1 freezes its
...
complete; formal status remains **In progress** pending commit, push, and exact
remote CI.
